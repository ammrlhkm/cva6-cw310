...
} elseif {$::env(BOARD) eq "bergen"} {
      add_files -fileset constrs_1 -norecurse constraints/bergen.xdc
} else {
      exit 1
}
...
if {$::env(BOARD) eq "genesys2"} {
    ...
    set registers "../../vendor/pulp-platform/common_cells/include/common_cells/registers.svh"
      ...
      read_verilog -sv {src/bergen.svh ../../vendor/pulp-platform/common_cells/include/common_cells/registers.svh}
      set file "src/bergen.svh"
      set registers "../../vendor/pulp-platform/common_cells/include/common_cells/registers.svh"
} else {
    exit 1
}
